								...
								<div id="myTabContent" class="tab-content">
								  <div role="tabpanel" class="tab-pane fade active in" id="home" aria-labelledby="home-tab">
									...
									<div class="col-md-3 artist-grid">
										<a  href="single"><img src="images/a3.jpg" title="allbum-name"></a>
										 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" href="single">Sukhwinder singh</a>
										</div>
									<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a6.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" href="single">Shekhar Ravjiani</a>
										</div>
									<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a7.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" href="single">Shalmali</a>
										</div>
									<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a4.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" href="single">Sajid-Wajid</a>
										</div>
									<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a5.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" href="single">Atif Aslam</a>
										</div>
										<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a1.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
											<a class="art" href="single">A R Rahman</a>
										</div>
									<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a2.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
												<a class="art" href="single">Shreya Ghoshal</a>
										</div>
									<div class="col-md-3 artist-grid">
											<a  href="single"><img src="images/a8.jpg" title="allbum-name"></a>
											 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
											<a class="art" href="single">Lata Mangeshkar</a>
										</div>
											<div class="col-md-3 artist-grid">
													<a  href="single"><img src="images/a9.jpg" title="allbum-name"></a>
													 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
														<a class="art" href="single">Arijit Sing</a>
												</div>
											<div class="col-md-3 artist-grid">
													<a  href="single"><img src="images/a10.jpg" title="allbum-name"></a>
													 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
														<a class="art" href="single">Sunidhi Chauhan</a>
												</div>
												<div class="col-md-3 artist-grid">
													<a  href="single"><img src="images/a11.jpg" title="allbum-name"></a>
													 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
														<a class="art" href="single">Yo Yo Honey Singh</a>
												</div>
											<div class="col-md-3 artist-grid">
												<a  href="single"><img src="images/a12.jpg" title="allbum-name"></a>
												 <a href="single"><i class="glyphicon glyphicon-play-circle"></i></a>
													<a class="art" href="single">Neeti Mohan</a>
											</div>
											<div class="clearfix"> </div>
										</div>
								  </div>
						...
						<!--//discover-view-->
								<div class="albums fourth">
										<div class="tittle-head two">
											...
											<div class="col-md-3 artist-grid">
												<a href="single"><img src="images/v5.jpg" title="allbum-name"></a>
												<div class="inner-info"><h5>Pop</h5></div>
											</div>
											<div class="clearfix"> </div>
										</div>
